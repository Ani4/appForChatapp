...
export default class Message extends Component{
	...
	addTestMessages(){
		...
		for(let i = 0; i < 100; i ++){
			...
			const newMsg = {
				author: `Author ${i}`,
				body: `The body of message hello The body of message helloThe body of message helloThe body of message hello ${i}`,
				avatar: avatar,
				me: isMe,
			}
					...
					<div className="header">
						...
						<div className="right">
							...
							<div className="user-bar">
								<div className="profile-name">Aniket kumar</div>
